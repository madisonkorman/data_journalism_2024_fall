...
md_senate_expenses <- read_csv("data/md_senate_for_open_refine.csv")
...
#mutate(purpose = case_when(
 # purpose == "AD BUY" ~ "Advertising",
 # purpose == "Media Advertising" ~ "Advertising",
 # purpose == "Online Advertising" ~ "Advertising",
 # purpose == "ADS" ~ "Advertising",
  #purpose == "PRINT ADS" ~ "Advertising",
 # TRUE ~ purpose
#)) |>
 # mutate(purpose = str_to_upper(purpose)) |>
  group_by(purpose)|>
...
**A2.** Both of there top expenditures were for advertising which is not surprising considering they are running a campaign.
...
**A3.** For The Alsobrooks campaign there was a steep upturn in spending leading up to the election, peaking in April, and it fell off immediately after. Hogan does not seem to report as much data, but the spending for his campaign peaked in May.
...
**A4.** There are 23 individual recipiants for the Alsobrooks payroll. Hogan does not seem to report names or salaries. Alsobrooks salary spending: 822015	Hogan salary spending:
...
**A5** The Alsobrooks campaign spends a lot of money on credit card fees which is odd and would be worth looking into. Additionally, it would be interesting to look into why Hogan's campaign does not report as much information at the Alsobrooks campaign. 
