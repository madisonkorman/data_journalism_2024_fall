...
boe_results|>
  ...
  mutate(
    ...
    percentage = as.numeric(str_remove(early_voting, "%"))
  )|>
  ggplot() +
...
**A2** John King for Governor Campaign in April 3, 2024.
...
**A3** You could see what day of the month the majority of press releases came out. You could also see hwat time period or month had the most press releases. 
