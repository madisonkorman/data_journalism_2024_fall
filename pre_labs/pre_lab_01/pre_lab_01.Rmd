...
<chr> the last name column probably has the last names and the amount be their voting percentage.
...
**Answer**
head() had a lot of information included so it seems as though the code below probably narrows down the information. 
...
**Answer**
The numbers seem to be re-ordered. Before the dates were in order and now they're not.
...
**Answer**
This information includes memos. 
### Task 9
...
**Answer**
It includes Count Contributions and Total amounts.
...
**Answer**
This codeblock includes information like the mean and median amounts.
### Task 11
...
This codeblock includes minimum and maximum amounts.