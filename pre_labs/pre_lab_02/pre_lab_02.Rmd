...
**Answer** Making the number more easy to read and understand
...
**Answer** We have a new select function which will filter for the columns we want.
...
**Answer** It is more useful because it only includes the information we need. 
...
**Answer** It is assigning names for the values that fit the criteria. 
...
maryland_winred_categories <- maryland_winred_contributions |>
  mutate(
    amount_category = case_when(
        ...
        amount >= 1500 & amount < 3000 ~ "Between $1500 and $2999",
...
**Answer** To differentiate from the other data.
...
**Answer:**The structure of the date was changed.
