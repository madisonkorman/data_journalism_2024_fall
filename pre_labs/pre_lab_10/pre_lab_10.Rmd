...
**Task** Run the following code to load data. Describe what you see in the answer space below. What columns exist in this data? **Answer** It is showing us a glimpse of the data, it has colums like to school and precinct but also colums I am not used to seeing like shape, shape_area and shape_length.
...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **Answer** This line of code takes me to the pg_precincts table view so I can see all of the data in table form. 
...
**Task** Run the following code. Describe the output in the space below. **Answer** This code displays a gray map that is broken down by precincts.
...
**Task** Run the following code. Describe the output in the space below. **Answer** The following code installs and loads tigris.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This code organizes by county and shows a glimpse of the data., 
...
**Task** Run the following code. Describe the output in the space below. **Answer** This code filters the data by STATEFP when equals 24.
...
**Task** Run the following code. Describe the output in the space below. **Answer** The code dispays a map organized by county rather than precinct.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This code shows pg county broken down by precincts but does not seem to have any data yet.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This code loads in more data and filters ir by pg county.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This code joins the pg_precincts and 
pg_turnout data with a left join.
```{r}
...
**Task** Run the following code. Describe the output in the space below. **Answer** This code gives me a map of pg county broken down by precincts with the turnout data in blue.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This code loads in the eligable voter data organized by party and arranges the totals in deescalating order.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This code get the populations by county in maryland.
...
**Task** Run the following code. Describe the output in the space below. **Answer** this shows maryland population data by county in 2022.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This code shows voters by county broken down by the party affiliation.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This line of code is cleaning names and mutating the data so it can be easily joined. 
...
**Task** Run the following code. Describe the output in the space below. **Answer** This line of code left joins md_county_population and voters_by_county.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This line of code corrects the county names so they can be proper.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This line of code joins voters_by_county and md_county_population and divides the totals by 10,000 to get the votes per 10k in maryland.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This code shows the data we previosly joined on a map broken down by county in blue, the voters per 10k.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This map changes the colors and theme of the map.
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Answer** There are less voters per 10k on the western shore of maryland.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This code adds a column for una_voters_per_10k (unaffiliated)
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see, especially on the ends of the scale? **Answer** There are more una_voters_per_10k on the western shore of maryland but it is a bit more consistant on the eastern shore.
