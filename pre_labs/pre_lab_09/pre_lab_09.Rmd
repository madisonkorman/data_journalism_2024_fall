...
https://datawrapper.dwcdn.net/BH9bO/1/   
...
md_gov_county <-md_gov_county <- mutate(md_gov_county, 
               total_votes = rowSums(md_gov_county[ , c("Moore", "Cox","Lashar","Wallace","Harding")]), 
               wes_moore_percentage = (Moore / total_votes) * 100)
...
It went from the whole United States to only shwoing Maryland.
...
now instead of having random numbers, it says the county as well as the Moore precentage.
...
https://datawrapper.dwcdn.net/t3mjv/1/
