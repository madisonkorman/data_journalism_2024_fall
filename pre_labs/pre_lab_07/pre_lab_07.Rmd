...
```{r echo=FALSE}
census_api_key("3d3f88866c4da579b432a35db04b8f20fe94e438", install=TRUE)
```
...
Is the difference between Calvert and Montgomery significant? **Answer** They seem to have a big difference in the margin if error.

Is the difference between Howard and everyone else significant? **Answer** Howard seems to be pretty consistent with the other places with reasonably low margins of error.  
...
**Answer** The zipcode 20609 is has a estimated median household income below $50,000.
...
What types of jobs are people working there, what are the demographics, and how do those zipcodes tend to vote. 
