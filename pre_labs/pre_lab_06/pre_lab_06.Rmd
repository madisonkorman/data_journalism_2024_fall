...
**Task** Get rid of rows we don't need by running the codeblock below. What problems remain? **Answer** The columns are still not labled and the info is compressed under the candidate column.
...
**Task** Run the codeblock below. What changed, and what issues or problems remain? **Answer** It separted the canditate, party, and added the office. It also gave new names to the columns
